...
class Model:
    ...
    def __init__(self, ALPHA, BETA, LAMDA, applyDecay=True, applyICF = True, applyCWW = True):
        ...
        self.lamda = LAMDA
        self.deleted_clusters={}  # delete_clusterID -> [ cn, cw, cwf, cww , cd, csw]
        self.deleted_clusters_keyword={}
        self.clusters_keyword={}
        self.word_counter = {0:0}     #count no of word
    ...
    def checkOldClusters(self, LAMDA):
        threshold = 0.00001              #0.00001  #0.000003
        clustersToDelete = {}
    ...
    def deleteOldCluster(self, clusterID, CF):
        CF_copy=CF.copy()
        list_word={}
        self.deleted_clusters[clusterID]=CF_copy
        for wid , freq in CF[con.I_cwf].items():
            word = self.wid_word_map[wid]
            list_word[word]=freq
        self.deleted_clusters_keyword[clusterID]=list_word   #store word_frequency 
